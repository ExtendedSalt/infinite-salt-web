...
export default function Component({ providers }) {
  return (
    <>
      ...
      <div className="h-screen flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8" style={{ fontFamily: 'Montserrat' }}>
        <div className="max-w-md w-full space-y-8">
          <div className="items-center justify-center w-full">
            <div className=" fill-white px-3" style={{ color: "white" }}>
          ...
          <div className="mt-8 space-y-6">
            <div>
              <button
                className="group relative w-full flex justify-center py-2 px-4 border border-transparent text-sm font-medium rounded-md text-white bg-neutral-500 hover:bg-[#1778F2] focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 duration-300"
                onClick={() => signIn(providers.facebook.id)}
              >
                <FontAwesomeIcon icon={faFacebook} className='mt-px mr-2 h-4 w-4' />
                Sign in With Facebook
              </button>
              <br />

              <button
                className="group relative w-full flex justify-center py-2 px-4 border border-transparent text-sm font-medium rounded-md text-white bg-neutral-500 hover:bg-white hover:text-black focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 duration-300"
                onClick={() => signIn(providers.github.id)}
              >
                <FontAwesomeIcon icon={faGithub} className='mt-px mr-2 h-4 w-4' />
                Sign in With Github
              </button>
